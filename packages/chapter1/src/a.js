...
// JuniorEngineer의 프로토타입을 새로운 객체로 생성 Worker.prototype으로 설정
JuniorEngineer.prototype = Object.create(Worker.prototype);

// JuniorEngineer 생성자에서 worker 생성자를 호출할 수 있게
JuniorEngineer.prototype._super = Worker;

// health에서 1를 감소하는 메서드 추가
Worker.prototype.work = function () {
  this._health--;
};

// health를 return 하는 메서드 추가
Worker.prototype.getHealth = function () {
  return this._health;
};

// _intelligence를 return 하는 메서드 추가
JuniorEngineer.prototype.getIntelligence = function () {
  return this._intelligence;
};

// Worker 프로토타입의 work를 호출하고 _intelligence에 값으 1증가하는 메서드
